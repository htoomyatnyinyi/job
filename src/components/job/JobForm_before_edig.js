...
//   return (
//     <div className="p-6 max-w-4xl mx-auto text-black dark:text-white rounded-lg shadow-md">
//       {error && (
...
// //       <div className="bg-white dark:bg-gray-800 shadow-lg rounded-lg w-full max-w-3xl p-6">
// //         {!previewMode ? (
...
// //                     type="button"
// //                     onClick={() => removeField(index, "responsibilities")}
// //                     className="ml-2 px-3 py-1 text-red-500 hover:bg-red-100 rounded"
// //                   >
// //                     Remove
// //                   </button>
// //                 </div>
